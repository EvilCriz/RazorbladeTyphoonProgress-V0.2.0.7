...
public class PlayerSave : ModPlayer
{
	...
	//[RU]: Выдает предмет Items.RazorbladeTyphoonProgress при создании персонажа
	//------------------------------------------
	//[EN]: Grants Items.RazorbladeTyphoonProgress upon character creation
	public override IEnumerable<Item> AddStartingItems(bool mediumCoreDeath) 
		=> mediumCoreDeath ? 
			null : 
			new[] { new Item(ModContent.ItemType<Items.RazorbladeTyphoonProgress>()) };
